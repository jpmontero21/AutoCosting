...
namespace AutoCosting.Areas.Identity.Pages.Account
{
    ...
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("ID de usuario '{UserId}' inició con un codigo derecuperación.", user.Id);
            ...
            {
                _logger.LogWarning("Código de recuperación no válido introducido para el ID de Usuario '{UserId}' ", user.Id);
